...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'<head><meta charset="gb2312" /><title>KindEditor</title>',
		'<style>',
...
_plugin('core', function(K) {
	...
	self.clickToolbar('about', function() {
		var html = '<div style="margin:20px;">' +
			...
			'<div>Copyright &copy; <a href="http://#/" target="_blank">kindsoft</a> All rights reserved.</div>' +
			'</div>';
		self.createDialog({
			name : 'about',
			width : 300,
