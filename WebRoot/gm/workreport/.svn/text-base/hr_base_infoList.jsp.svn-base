...
<body>	
	<form id="searchForm" action="<%=request.getContextPath()%>/gm/workreport/Gm_workreport_set!searchList.do" method="post">
	<div class="divMod2">
	...
	<div>
      ...
      <td><c:out value="${result.branchname}" /></td>
				...
				<td class="btnCol">
				<a href="#" onclick="openDG('工作总结审核人设定','<%=request.getContextPath()%>/gm/workreport/Gm_workreport_set!set.do?id=${result.id}','gm_workreport_setDtl')">设定</a>
				</td>
				</tr>
			</c:forEach>
		</table>
