...
<body>	
	...
	<form id="searchForm" action="<%=request.getContextPath()%>/hr/absence/Hr_absence!checkList.do" method="post">
	<div class="divMod2">
	...
	<div>
		<table class="dataListTable" width="100%">
           ...
           <td width="8%"><c:out value="${result.absence_type}" /></td>
           <td width="10%"><c:out value="${result.begin_date}" /></td>
           <td width="10%"><c:out value="${result.end_date}" /></td>
           <td width="15%"><c:out value="${result.reason}" /></td>
           <td width="10%"><c:out value="${result.input_date}" /></td>
           <td width="10%"><c:out value="${absence_state[result.absence_state]}" /></td>
           <td width="10%"><c:out value="${result.days}" /></td>
           <td width="10%">
