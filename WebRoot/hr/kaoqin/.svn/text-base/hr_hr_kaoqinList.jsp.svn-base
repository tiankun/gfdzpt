...
function baobiao()
{
	...
	document.form1.action = '<%=request.getContextPath()%>/hr/absence/Hr_kaoqin_audit!audit.do';
	document.form1.target = '_blank';
	document.form1.submit();
}
function query()
{
	document.form1.action = '<%=request.getContextPath()%>/hr/absence/Hr_kaoqin_audit!searchList.do';
	...
	<body>
		<form id="searchForm"
			action="<%=request.getContextPath()%>/hr/absence/Hr_kaoqin_audit!searchList.do" name="form1"
			method="post">
			<div class="divMod2">
				<div class="divMod1">
					查询条件
			...
			<div class="div-button">
				<a   onclick="baobiao();" style="cursor: hand;" 
					 class="link">考勤查看</a>
				<input type="reset" value="重置" class="button" />
				<input type="button" onclick="query();"  value="查询" class="button" />
			</div>
