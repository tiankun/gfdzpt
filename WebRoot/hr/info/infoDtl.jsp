...
<script type="text/javascript">${operationSign}</script>
	...
	<form name="form1" action="<%=request.getContextPath()%>/hr/info/Hr_base_info!${editMod}Dtl.do" method="post">
	<input type="hidden" id="editMod" name="editMod" value="${editMod}"/>
	<input type="hidden" name="IsPostBack" value="${IsPostBack}"/>	
	<input type="hidden" name="id" value="${record.id}"/>
	<input type="hidden" name="hr_type" value="2"/></td>
	<input type="hidden" name="duty_id" value="${record.duty_id}"/>
	<input type="hidden" name="lr_time" value="${record.lr_time}"/>
	<input type="hidden" name="subflag" id="subflag" value="${record.subflag}"/>
		<table class="table_border" style="width:100%">
			...
			<td style="width:35%">
			<input type="text" name="card_num" id="card_num" value="${record.card_num}" dataType="" maxLength="50"  style="width:95%" class="textBoxNoBorder"/></td>
            </tr>
            <tr>
			...
			<td style="width:35%">
			<input type="text" name="email" value="${record.email}" dataType="Email" require="false" maxLength="50"  style="width:95%" class="textBoxNoBorder"/></td>
            </tr>
            <tr>
			...
			<td style="width:35%">
			<input type="text" name="phone" value="${record.phone}" maxLength="11"  style="width:95%" class="textBoxNoBorder"/></td>
            </tr>
            <tr>
			...
			<td style="width:35%">
			<input type="text" name="jr_time" value="${record.jr_time}"  dataType="Date" onfocus="WdatePicker()" style="ime-mode:disabled"  style="width:95%" class="textBoxNoBorder"/></td>
            </tr>
            <tr>
            ...
            <textarea name="remark" colspan="3" rows ="5" value="${record.remark}" maxLength="500"  style="width:98%;border: 0px">${record.remark}</textarea>
			</td>
			</tr>
		</table>
		<br/>
