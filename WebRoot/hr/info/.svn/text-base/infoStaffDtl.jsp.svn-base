...
<script type="text/javascript">${operationSign}</script>
	...
	<form name="form1" action="<%=request.getContextPath()%>/hr/info/Hr_base_info!editStaff.do" method="post">
	...
	<input type="hidden" name="subflag" id="subflag" value="${record.subflag}"/>
		<table class="table_border" style="width:100%">
			...
			<td style="width:35%">
			<input type="text" name="jr_time" value="${record.jr_time}"   onfocus="WdatePicker()" style="ime-mode:disabled"  style="width:95%" class="textBoxNoBorder"/></td>
            </tr>
            <tr>
