...
<script type="text/javascript">${operationSign}</script>
	...
	<form name="form1" action="<%=request.getContextPath()%>/hr/info/Hr_base_info!addStaff.do" method="post">
	...
	<input type="hidden" name="subflag" id="subflag" value="${record.subflag}"/>
		<table class="table_border" style="width:100%">
			...
			<td style="width:35%">
			<input type="text" name="old_name" value="${record.old_name}" maxLength="50"  style="width:95%" class="textBoxNoBorder"/></td>
            </tr>
			...
			<td style="width:35%">
			<input type="text" name="habbit" value="${record.habbit}" maxLength="50" style="width:95%" class="textBoxNoBorder"/></td>
			</td>
            </tr>
            <tr>
			...
			<td style="width:35%">
			<input type="text" name="card_num" id="card_num" value="${record.card_num}" dataType="IdCard" maxLength="50"  style="width:95%" class="textBoxNoBorder"/></td>
            </tr>
            <tr>
			<th align="center" style="width:10%">岗位:<span style="color:Red;">*</span></th>
			<td style="width:35%">
			...
			<td style="width:35%">
			<input type="text" name="home_numb" value="${record.home_numb}" dataType="Phone" require="false" maxLength="200"  style="width:95%" class="textBoxNoBorder"/></td>
            <th align="center" style="width:10%">移动电话:<span style="color:Red;">*</span></th>
			<td style="width:35%">
			<input type="text" name="phone" value="${record.phone}" maxLength="11"  style="width:95%" dataType="Mobile" require="false" class="textBoxNoBorder"/></td>
            </tr>
            <tr>
            ...
            <th align="center" style="width:10%">进入公司时间:<span style="color:Red;">*</span></th>
			<td style="width:35%">
			<input type="text" name="jr_time" value="${record.jr_time}" dataType="Require"  onfocus="WdatePicker()" style="ime-mode:disabled"  style="width:95%" class="textBoxNoBorder"/></td>
            </tr>
            <tr>
            ...
            <tr>
            <th align="center" style="width:10%">任职状态:<span style="color:Red;">*</span></th>
			<td style="width:35%">
			<select name="hr_type" id="hr_type" dataType="Require"  class="ddlNoBorder"><option value="">---</option>
			<c:forEach items="${hr_type}" var="hr_type">
			<option value="${hr_type.key}" <c:if test="${record.hr_type==hr_type.key}">selected</c:if>>${hr_type.value}</option>
			</c:forEach>
			</select></td>
            ...
            <textarea name="remark" rows ="5" value="${record.remark}" maxLength="500"  style="width:95%">${record.remark}</textarea>
			</td>
			</tr>
		</table>
		<br/>
