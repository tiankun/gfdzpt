...
<body>	
	<form id="searchForm" action="<%=request.getContextPath()%>/materielapply/Gm_ration_apply!addfromitem.do" method="post">
	<div class="divMod2">
	<div class="divMod1">查询条件</div>
		<table width="99%" class="search_border">
			...
			<th>项目:</th>
			<td>
			<input type="text" id="name" name="name" value="${searchMap.name}"  class="textBox"/>
			...
			<th>计划名称:</th>
			<td>
			<input type="text" name="item_name" value="${searchMap.item_name}"   style="width:95%" class="textBox"/></td>
			<th></th>
			<td>
			</td>
            </tr>
	...
	<div>
      ...
      <td><c:out value="${result.made_date}" /></td>
				...
				<td class="btnCol">
				<a href="<%=request.getContextPath()%>/materielapply/Gm_ration_apply!getmateriel.do?id=${result.id}" >选择材料</a>
				</td>
				</tr>
			</c:forEach>
		</table>
