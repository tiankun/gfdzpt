...
<script type="text/javascript">${operationSign}</script>
		...
		<!-- 作废记录 -->
		<c:if test="${not empty record.zf_reason}">
		<div class="divMod2">
		<div class="divMod1">作废记录</div>
		<table class="table_border" style="width:100%">
			<tr>
			<th align="center" style="width:10%">作废人:</th>
			<td style="width:35%">${record.zf_pname}</td>
			<th align="center" style="width:10%">作废时间:</th>
			<td style="width:35%">${record.zf_time}</td>
			</tr>
			<tr>
			<th align="center" style="width:10%">作废原因:</th>
			<td colspan="3">
			<textarea rows ="3" maxLength="500" style="width:98%;border: 0px">${record.zf_reason}</textarea>
			</td>
			</tr>
		</table>
		</div>
