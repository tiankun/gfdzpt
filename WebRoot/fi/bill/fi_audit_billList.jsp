...
<body>	
	<form id="searchForm" action="<%=request.getContextPath()%>/fi/bill/Fi_bill_audit!searchList.do" method="post">
	<div class="divMod2">
	...
	<div>
		<table class="dataListTable" width="100%">
			...
			<c:forEach items="${record}" var="result" varStatus="status">
				...
				<c:if test="${result.bill_state=='1'}">
				<a href="#" onclick="openDG('审批','<%=request.getContextPath()%>/fi/bill/Fi_bill_audit!edit.do?id=${result.id}','fi_billDtl')">审批</a>
				</c:if>
