...
<script type="text/javascript">${operationSign}</script>
	...
	<form name="form1" action="<%=request.getContextPath()%>/supplier/Supplier!${editMod}.do" method="post">
	...
	<input type="hidden" name="id" value="${record.id}"/>
		<table class="table_border" style="width:100%">
            ...
            <tr>
			<th align="center" style="width:10%">供应商名称:<span style="color:Red;">*</span></th>
			<td style="width:35%">
            ...
            <tr>
			<th align="center" style="width:10%">联系人:<span style="color:Red;">*</span></th>
			<td style="width:35%">
			<input type="text" name="lxr" value="${record.lxr}" dataType="Require" maxLength="100"  style="width:95%" class="textBoxNoBorder"/></td>
			<th align="center" style="width:10%">联系电话:<span style="color:Red;">*</span></th>
			<td style="width:35%">
			<input type="text" name="lxdh" value="${record.lxdh}" dataType="Require" maxLength="100"  style="width:95%" class="textBoxNoBorder"/></td>
            </tr>
            <tr>
			<th align="center" style="width:10%">供应商等级:</th>
			<td style="width:35%">
