...
public class Sys_messageAction extends BaseAction {
	...
	public String searchList(HttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		return "/web/hr_sys_messageList.jsp";
	}
	...
	public String delete(HttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		dataBaseControl.executeSql("DELETE FROM Hr_sys_message WHERE ID in (?)", new Object[]{s_id});
		
		return "/web/Hr_sys_message!searchList.do";
	}
